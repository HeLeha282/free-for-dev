# free-for.dev
#изменение во второй строке файла в ветке branch2 (коммит 1 - branch2)
#изменение во второй строке файла в ветке branch1 (commit 1 - branch1)
...
#изменение в середине файла в ветке branch2 (коммит 1 - branch2)
